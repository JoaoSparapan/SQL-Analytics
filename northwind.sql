...
create view total_income_1997 as
select 
...
create view financial_income as
...
create view customers_groups as
select  
	c.company_name
	, sum((od.unit_price * od.quantity) * (1-od.discount)) as total
...
create view filtered_customers as
...
create view main_uk_customer as
